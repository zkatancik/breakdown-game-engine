...
bin/test: $(TEST_GRAVERUNNER_OBJ_FILES_RELEASE) $(GRAVERUNNER_OBJ_FILES_RELEASE) $(BREAKOUT_OBJ_FILES_RELEASE) $(TD_OBJ_FILES_RELEASE)
	mkdir -p $(dir $@)
	g++  $^ $(LDFLAGS_RELEASE) -o $@

bin/test_d: $(TEST_GRAVERUNNER_OBJ_FILES_DEBUG) $(GRAVERUNNER_OBJ_FILES_DEBUG) $(BREAKOUT_OBJ_FILES_DEBUG) $(TD_OBJ_FILES_DEBUG)
	mkdir -p $(dir $@)
	g++  $^ $(LDFLAGS_DEBUG) -o $@
