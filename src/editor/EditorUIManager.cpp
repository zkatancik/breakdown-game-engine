...
//
//  editorButton = new GraveRunnerButton();
...
//
//  returnButton = new GraveRunnerButton();
...
//  selectLevel1Button = new GraveRunnerButton();
...
//
//  selectLevel2Button = new GraveRunnerButton();
...
//
//  selectLevel3Button = new GraveRunnerButton();
