...
void GraveRunnerLogic::createInstructionsLevel(int width, int height) {
  ...
  mInstructionsMenu->addObject(
      std::make_shared<GraveRunnerButton>(*mInstructionsMenu, width, 2 * height / 3 + 75, width / 4,
...
void GraveRunnerLogic::createChangeLanguageLevel(int width, int height) {
  ...
  mLanguageMenu->addObject(
      std::make_shared<GraveRunnerButton>(*mLanguageMenu, width / 2, height / 3, width / 4,
  ...
  mLanguageMenu->addObject(std::make_shared<GraveRunnerButton>(
...
void GraveRunnerLogic::createStartMenuLevel(int width, int height) {
  ...
  // matter for buttons
  mStartMenu->addObject(std::make_shared<GraveRunnerButton>(*mStartMenu, width, height / 3,
                                                            784, 295, u8"START",
  ...
  mStartMenu->addObject(std::make_shared<GraveRunnerButton>(*mStartMenu, width, height / 2,
  ...
  // Add the change language button to the start menu
  mStartMenu->addObject(std::make_shared<GraveRunnerButton>(*mStartMenu, width, height / 2 + 125,
                                                            784, 295, u8"HOW TO PLAY",
                                                            instructionsButtonHook));
