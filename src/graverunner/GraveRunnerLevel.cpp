    ...
    for (int j = 0; j < blocksPerRow; j++) {
      ...
      if (b.block_Type != GraveRunnerBlockType::NoBlock) {
        ...
        if (b.block_Type == GraveRunnerBlockType::PlainBlock) {
          obj = std::make_shared<GraveRunnerBlock>(*this, x, y, b, 1, blockSize);
        } else if (b.block_Type == GraveRunnerBlockType::Wall) {
          obj = std::make_shared<GraveRunnerBlock>(*this, x, y, b, 0, blockSize);
