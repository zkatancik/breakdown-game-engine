...
SelectableComponent::SelectableComponent(GameObject &gameObject,
    ...
    : GenericComponent(gameObject),
      mSelectHook(std::move(onSelectHook)),
      mHoverHook([&]() {}),
      mNotSelectHook([&]() {}) {}
...
SelectableComponent::SelectableComponent(GameObject &gameObject,
    ...
    : GenericComponent(gameObject),
      mSelectHook(std::move(onSelectHook)),
      mHoverHook(std::move(onHoverHook)),
      mNotSelectHook([&]() {}) {}

SelectableComponent::SelectableComponent(
    GameObject &gameObject, std::function<void(void)> onSelectHook,
    std::function<void(void)> onHoverHook,
    std::function<void(void)> NotSelectHook)
    : GenericComponent(gameObject),
      mSelectHook(std::move(onSelectHook)),
      mHoverHook(std::move(onHoverHook)),
